...
public final class RpcResponse {
  ...
  public interface ResponseOrBuilder extends
     ...
     * <code>.Status statusEnum = 1;</code>
     */
    ResponseStatus.Status getStatusEnum();
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final com.google.protobuf.Descriptors.Descriptor
        getDescriptor() {
      return RpcResponse.internal_static_Response_descriptor;
    }

    @java.lang.Override
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
        internalGetFieldAccessorTable() {
      return RpcResponse.internal_static_Response_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              RpcResponse.Response.class, RpcResponse.Response.Builder.class);
    }
     ...
     * <code>.Status statusEnum = 1;</code>
     */
    public ResponseStatus.Status getStatusEnum() {
      @SuppressWarnings("deprecation")
      ResponseStatus.Status result = ResponseStatus.Status.valueOf(statusEnum_);
      return result == null ? ResponseStatus.Status.UNRECOGNIZED : result;
    }
     ...
     * <code>.Operate operate = 3;</code>
     */
    public RpcOperate.Operate getOperate() {
      @SuppressWarnings("deprecation")
      RpcOperate.Operate result = RpcOperate.Operate.valueOf(operate_);
      return result == null ? RpcOperate.Operate.UNRECOGNIZED : result;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (statusEnum_ != ResponseStatus.Status.OK.getNumber()) {
        output.writeEnum(1, statusEnum_);
      }
      if (rid_ != 0) {
        output.writeSInt32(2, rid_);
      }
      if (operate_ != RpcOperate.Operate.HeartBeat.getNumber()) {
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      RpcResponse.Response other = (RpcResponse.Response) obj;
    ...
    public static RpcResponse.Response parseFrom(
    ...
    public static RpcResponse.Response parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static RpcResponse.Response parseFrom(
    ...
    public static RpcResponse.Response parseFrom(java.io.InputStream input)
        throws java.io.IOException {
    ...
    public static RpcResponse.Response parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static RpcResponse.Response parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static Builder newBuilder(RpcResponse.Response prototype) {
    ...
    public static final class Builder extends
      ...
      @java.lang.Override
      public RpcResponse.Response getDefaultInstanceForType() {
        return RpcResponse.Response.getDefaultInstance();
      }

      @java.lang.Override
      public RpcResponse.Response build() {
        RpcResponse.Response result = buildPartial();
      ...
      @java.lang.Override
      public RpcResponse.Response buildPartial() {
        RpcResponse.Response result = new RpcResponse.Response(this);
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof RpcResponse.Response) {
          return mergeFrom((RpcResponse.Response)other);
        } else {
      ...
      public Builder mergeFrom(RpcResponse.Response other) {
        if (other == RpcResponse.Response.getDefaultInstance()) return this;
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        RpcResponse.Response parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (RpcResponse.Response) e.getUnfinishedMessage();
       ...
       * <code>.Status statusEnum = 1;</code>
       */
      public Builder setStatusEnum(ResponseStatus.Status value) {
        if (value == null) {
       ...
       * <code>.Operate operate = 3;</code>
       */
      public Builder setOperate(RpcOperate.Operate value) {
        if (value == null) {
          throw new NullPointerException();
        }
  ...
  checkByteStringIsUtf8(value);
    ...
    private static final RpcResponse.Response DEFAULT_INSTANCE;
    static {
      DEFAULT_INSTANCE = new RpcResponse.Response();
    }

    public static RpcResponse.Response getDefaultInstance() {
